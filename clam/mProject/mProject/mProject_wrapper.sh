...
#while getopts ":hl" opt "$PARAMETERS"; do
#  case $opt in
#    h)
...
for inputfile in $INPUTDIRECTORY/*.fits; do
    #get name of output file on the basis of input file
    filename=`basename $inputfile`
    echo "Filename: $filename" >> $STATUSFILE
    ...
    echo "Running: echo $inputfile > $outputfile" >> $STATUSFILE
