...
#
#COMMAND = WEBSERVICEDIR + "/mProject_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"

#Or for the shell variant:
COMMAND = WEBSERVICEDIR + "/mProject_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
...
PARAMETERS =  [
    ('Switches', [
        BooleanParameter(id='low',name='lower case',description='stuff',paramflag='-l'),
        ...
        #StringParameter(id='z',name='z',description='Processing is done utilizing the drizzle algorithm. factor is a floating point number; recommended drizzle factors are from 0.5 to 1.',maxlength=255),
    ] )
]
