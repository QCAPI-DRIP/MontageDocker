...
SYSTEM_ID = "mArchiveExec"
#System name, the way the system is presented to the world
SYSTEM_NAME = "mArchiveExec"

#An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "mArchiveExec: Given a table of archive images (generated by mArchiveList), calls mArchiveGet on each one in sequence to retrieve all the files into the current directory."
...
PROFILES = [
    Profile(
        InputTemplate('region', PlainTextFormat,"Table of archive images, generated by mArchiveList.",
        ...
        #------------------------------------------------------------------------------------------------------------------------
        OutputTemplate('output',PlainTextFormat,'num-images from region.tbl are retrieved into the current directory. num-failed is a count of failed attempts to retrieve images; turn on debugging to see the errors generated by mArchiveGet.',
...
#
COMMAND = WEBSERVICEDIR + "/mArchiveExec_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"

#Or for the shell variant:
#COMMAND = WEBSERVICEDIR + "/mArchiveExec_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
...
PARAMETERS =  [
    ('Switches', [
        ...
        ChoiceParameter(id='debugg_level',name='debugg_level',description='Prints out additional debugging information; in this version, the only supported level is 1.', choices=['0','1'],default='0'),
