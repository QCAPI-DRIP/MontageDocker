...
#
COMMAND = WEBSERVICEDIR + "/mJPEG_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"

#Or for the shell variant:
#COMMAND = WEBSERVICEDIR + "/mJPEG_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
...
PARAMETERS =  [
    ('Switches', [
        BooleanParameter(id='d',name='d',description='Print out additional debugging information'),     
        StringParameter(id='t',name='t',description='Increasing the value of power will enhance the contrast between colors; useful when all pixels are close to white, but you wish to accentuate the color difference.',maxlength=64),
        StringParameter(id='ct',name='ct',description='Choose a color table for pseudo-color images; color-table can be an integer between 0 and 11. Click here for samples of each color table.',maxlength=64),
        StringParameter(id='gray',name='gray',description='image name and stretch information to be used for gray. eg.:input/SINGS_B.fits 0s 99.999% gaussian',maxlength=255),
        StringParameter(id='red',name='red',description='image name and stretch information to be used for red. eg.:input/SINGS_B.fits 0s 99.999% gaussian',maxlength=255),
        StringParameter(id='green',name='green',description='image name and stretch information to be used for green. eg.:input/SINGS_B.fits 0s 99.999% gaussian',maxlength=255),        
        StringParameter(id='blue',name='blue',description='image name and stretch information to be used for blue. eg.:input/SINGS_B.fits 0s 99.999% gaussian',maxlength=255),                
    ] )
]
