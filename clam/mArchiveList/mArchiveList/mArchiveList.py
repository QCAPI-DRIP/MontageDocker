...
PROFILES = [
    Profile(
        #InputTemplate('in', PlainTextFormat,"Input FITS file to be reprojected.",
        ...
        #),
        #------------------------------------------------------------------------------------------------------------------------
        OutputTemplate('region',PlainTextFormat,'Two files are created as output provided by the input images.',
...
PARAMETERS =  [
    ('Arguments', [
        ...
        ChoiceParameter(id='survey',name='survey',description='survey', choices=['2MASS','DSS','SDSS','DPOSS'],default='DSS'),
        ChoiceParameter(id='band',name='band',description='band', choices=['j', 'h', 'k','u', 'g', 'r', 'i', 'z','f', 'j', 'n','DSS1', 'DSS1R', 'DSS1B', 'DSS2', 'DSS2B', 'DSS2R', 'DSS2IR'],default='DSS2R'),
        StringParameter(id='object|location',name='object|location',description='Object name or coordinate string to be resolved by NED (if string includes spaces, must be surrounded by double quotes)',maxlength=255),
        StringParameter(id='width',name='width',description='Width of area of interest, in degrees',maxlength=255),
        StringParameter(id='height',name='height',description='Height of area of interest, in degrees',maxlength=255),
    ] )
]
